...
public class PatchOperation : GameAsyncOperation
{
    ...
    public PatchOperation(string packageName, string buildPipeline, EPlayMode playMode, string serverAddress, MonoBehaviour coroutineBhv)
    {
        // 注册监听事件
        ...
        _machine.SetBlackboardValue(KWord.PackageName, packageName);
        _machine.SetBlackboardValue(KWord.PlayMode, playMode);
        _machine.SetBlackboardValue(KWord.BuildPipeline, buildPipeline);
        _machine.SetBlackboardValue(KWord.ServerAddress, serverAddress);
        _machine.SetBlackboardValue(KWord.CoroutineBehaviour, coroutineBhv);
    }
